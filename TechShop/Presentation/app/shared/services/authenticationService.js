(function (app) {
    ...
    authenticationService.$inject = ['$http', '$q', 'localStorageService', 'authData'];

    function authenticationService($http, $q, localStorageService, authData) {
        var tokenInfo;
...
})(angular.module('techShop.common'));